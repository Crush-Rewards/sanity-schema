...
export const post = defineType({
  ...
  fields: [
        ...
        defineArrayMember({
          ...
          fields: [
            ...
            defineField({
              ...
              type: "image",
              description:
                "Thumbnail shown before the video plays. Keeps the page light on load.",
            }),
            defineField({
              name: "caption",
              title: "Caption",
    ...
    defineField({
      ...
      initialValue: false,
      description:
        "Feature this post as the Editor's Pick on the blog home page. Only one post should be toggled at a time.",
    }),
    defineField({
      name: "isNew",
